...
Delta network is composed of several components, and all of them could be easily deployed using Docker images. Before starting the network, take a look at the system architecture to get a basic understanding about the network components:

{% content-ref url="system-overview.md" %}
[system-overview.md](system-overview.md)
{% endcontent-ref %}

To get your hands dirty and start to play with the network, check the getting started guide for a quick deployment guide of the network:
