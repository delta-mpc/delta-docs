...
```
$ docker pull deltampc/deltaboard:0.8.1
```
...
```
$ cd deltaboard
$ docker run -it --rm -v ${PWD}:/app deltampc/deltaboard:0.8.1 init
```
...
```
$ docker run -d --name=deltaboard -v ${PWD}:/app -p 8090:8090 deltampc/deltaboard:0.8.1
```
